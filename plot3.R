...
#function to multivariables plot  Sub_metering_X ~ DateTime
plotIt <- function ( plotableData, imageFile="plot3.png")
{
  print ( "ploting  ....")
  ...
  plot(plotableData$DateTime, 
       plotableData$Sub_metering_1, 
       type="l", col="black", 
